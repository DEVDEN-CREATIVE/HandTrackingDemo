...
function App() 
{
 ...
 // document.body.appendChild(btn_group);
  ...
  console.log(this);
  var ring=new Image();
  ring.setAttribute('src','https://DEVDEN-CREATIVE.github.io/Ring/ring4.png');
  
  var back_ring=new Image();
  back_ring.setAttribute('src','https://DEVDEN-CREATIVE.github.io/Ring/back_ring4.png');

  var brclet= new Image();
  brclet.setAttribute('src',"https://DEVDEN-CREATIVE.github.io/bracelet/bracelet1.png");

  var back_brclet= new Image();
  back_brclet.setAttribute('src',"https://DEVDEN-CREATIVE.github.io/bracelet/back_bracelet1.png");
